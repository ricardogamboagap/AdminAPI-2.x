...
public class GetInstancesQuery
{
    private readonly IDbContext _context;
    private readonly IEncryptionService _encryptionService;
    private readonly string _encryptionKey;

    public GetInstancesQuery(IDbContext context, IEncryptionKeyResolver encryptionKeyResolver, IEncryptionService encryptionService)
    {
        _context = context;
    ...
    public IReadOnlyList<Instance> Execute(int? tenantId)
    {
        var instances = _context.Instances
            .Where(i => i.TenantId == tenantId || tenantId == null);
